#!/bin/bash
#SBATCH --job-name=tackle_baseline
...
OUTPUT_DIR="/ocean/projects/asc180003p/szaidi/Tackle_Sam2/ResultsB3_mp4"
CONDA_ENV="sam2_seg"
...
echo "=========================================="
echo "BASELINE B1 — Batch ${BATCH_ID}/3"
echo "=========================================="
...
echo "Baseline batch ${BATCH_ID} completed at $(date)"